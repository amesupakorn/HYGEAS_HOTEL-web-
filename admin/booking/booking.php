...
b.sDay AS check_in,
b.OutDay AS check_out,
b.TypeRoom AS room_type,
b.Guests,
b.Pay AS price,
c.Tel
FROM Booking AS b
JOIN Customer AS c ON b.Code_Cus = c.Code_Cus";
...
<head>
    ...
    <title>Hygeas | Booking</title>
    <link rel="stylesheet" href="booking.css"> <!-- เชื่อมโยงไฟล์ CSS -->
    <style>
    /* CSS สำหรับ pop-up */
    .popup {  
      position: fixed;
...
document.addEventListener('DOMContentLoaded', function () {
            ...
            // Check if the current hour is between 17 (5 PM) and 23 (11 PM)
            if (currentHour >= 17 && currentHour <= 22) {
                // If yes, show the button
                document.querySelector('button').style.display = 'block';
                document.querySelector('button').addEventListener('click', function () {
                    window.location.href = 'CancelTimeOut.php';});
            }else{
...
<body>
    <header>
        ...
        <button class="buttoncancel" type="button">Cancel Timeout!</button>
    </header>
    <?php
